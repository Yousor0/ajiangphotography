...
export default function About() {
  return (
    <div>
      <Header />
      {/* Images */}
      <div className="grid gap-5 p-5 grid-cols-1 sm:grid-cols-2 md:px-20 xl:px-40 mt-5 items-center">
        <div>
          <img
            src="https://portfolio-images-121638211942-us-east-1-an.s3.us-east-1.amazonaws.com/travel/DSC02288.jpg"
            alt="andrew"
            className="block w-full max-w-full object-contain sm:max-h-125 "
          />
        </div>
        <div>
          {/* About Section */}
          <div className="flex flex-col gap-1 ">
            <h2 className="text-5xl ">ABOUT ANDREW</h2>
